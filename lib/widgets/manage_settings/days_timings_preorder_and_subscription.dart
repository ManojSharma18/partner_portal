...
import 'package:partner_admin_portal/widgets/manage_settings/time_controller.dart';
import 'package:partner_admin_portal/widgets/manage_settings/time_controller_mob.dart';
...
class DaysTimingsPreorderSubscription extends StatefulWidget {
  final Map<String, Map<String, bool>> mealData;
  final Map<String,Map<String,Map<String,dynamic>>> mealTiming;
  final Map<String, Map<String, bool>> mealDataSub;
  final Map<String,Map<String,Map<String,dynamic>>> mealTimingSub;

  const DaysTimingsPreorderSubscription({Key? key, required this.mealData, required this.mealTiming, required this.mealDataSub, required this.mealTimingSub,}) : super(key: key);

  @override
  State<DaysTimingsPreorderSubscription> createState() => _DaysTimingsState();
}

class _DaysTimingsState extends State<DaysTimingsPreorderSubscription> {
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    '${ManageSettingsVariables.breakfastTimings.isEmpty
                                                        ? ManageSettingsVariables.mealTiming['Breakfast']!['Default']!['StartTime']
                                                        : ManageSettingsVariables.breakfastTimings[0]}',
                                                  ...
                                                  Text(
                                                    '${ManageSettingsVariables.breakfastTimings.isEmpty
                                                        ? ManageSettingsVariables.mealTiming['Breakfast']!['Default']!['StartTime']
                                                        : ManageSettingsVariables.breakfastTimings.length == 1 ?
                                                    ManageSettingsVariables.mealTiming['Breakfast']!['Default']!['StartTime']
                                                        : ManageSettingsVariables.breakfastTimings[ManageSettingsVariables.breakfastTimings.length -1 ]}',
                                                    style: SafeGoogleFont(
                                                      'Poppins',
                                                      fontSize: 16,
                                                      fontWeight: FontWeight.bold,
                                              ...
                                              SizedBox(height: 15,),
                                              for (int index = 0; index < ManageSettingsVariables.sessions.length && index < 4; index++)
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 45*fem,),
                                                        _buildSessionRowMob(index, ManageSettingsVariables.sessions, ManageSettingsVariables.selectedStartTimeBF, ManageSettingsVariables.selectedEndTimeBF,'Breakfast'),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                                ...
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 45*fem,),
                                                        _buildSessionRowMobSub(index, ManageSettingsVariables.sessionsSub, ManageSettingsVariables.selectedStartTimeBFSub, ManageSettingsVariables.selectedEndTimeBFSub,'Breakfast'),
                                                      ],
                                                    ),
                                                    SizedBox(height: 10),
                                                  ],
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 15,),
                                              for (int index = 0; index < ManageSettingsVariables.lunchSessions.length && index < 4; index++)
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 45*fem,),
                                                        _buildSessionRowMob(index, ManageSettingsVariables.lunchSessions, ManageSettingsVariables.selectedStartTimeLunch, ManageSettingsVariables.selectedEndTimeLunch,'Lunch'),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                                ...
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 45*fem,),
                                                        _buildSessionRowMobSub(index, ManageSettingsVariables.lunchSessionsSub, ManageSettingsVariables.selectedStartTimeLunchSub, ManageSettingsVariables.selectedEndTimeLunchSub,'Lunch'),
                                                      ],
                                                    ),
                                                    SizedBox(height: 10),
                                                  ],
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              for (int index = 0; index <
                                                  ManageSettingsVariables.dinnerSessions.length && index < 4; index++)
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 45*fem,),
                                                        _buildSessionRowMob(index, ManageSettingsVariables.dinnerSessions, ManageSettingsVariables.selectedStartTimeDinner, ManageSettingsVariables.selectedEndTimeDinner,"Dinner"),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                                ...
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 45*fem,),
                                                        _buildSessionRowMobSub(index, ManageSettingsVariables.dinnerSessionsSub, ManageSettingsVariables.selectedStartTimeDinnerSub, ManageSettingsVariables.selectedEndTimeDinnerSub,"Dinner"),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 15,),
                                              for (int index = 0; index < ManageSettingsVariables.sessions.length && index < 3; index++)
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 60,),
                                                        _buildSessionRow(index, ManageSettingsVariables.sessions, ManageSettingsVariables.selectedStartTimeBF, ManageSettingsVariables.selectedEndTimeBF,'Breakfast'),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                                ...
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 60,),
                                                        _buildSessionRowSub(index, ManageSettingsVariables.sessionsSub, ManageSettingsVariables.selectedStartTimeBFSub, ManageSettingsVariables.selectedEndTimeBFSub,'Breakfast'),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 15,),
                                              for (int index = 0; index < ManageSettingsVariables.lunchSessions.length && index < 3; index++)
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 60,),
                                                        _buildSessionRow(index, ManageSettingsVariables.lunchSessions, ManageSettingsVariables.selectedStartTimeLunch, ManageSettingsVariables.selectedEndTimeLunch,'Lunch'),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                                ...
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 60,),
                                                        _buildSessionRowSub(index, ManageSettingsVariables.lunchSessionsSub, ManageSettingsVariables.selectedStartTimeLunchSub, ManageSettingsVariables.selectedEndTimeLunchSub,'Lunch'),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 15,),
                                              for (int index = 0; index < ManageSettingsVariables.dinnerSessions.length && index < 3; index++)
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 60,),
                                                        _buildSessionRow(index, ManageSettingsVariables.dinnerSessions,
                                                            ManageSettingsVariables.selectedStartTimeDinner,
                                                            ManageSettingsVariables.selectedEndTimeDinner,"Dinner"),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                                ...
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 60,),
                                                        _buildSessionRowSub(index, ManageSettingsVariables.dinnerSessionsSub,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(margin: EdgeInsets.only(left: 30, right: 30, top: 30),
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text("Operational sessions and business model", style: TextStyle(
  ...
  Widget _buildSessionRow(int index, List<SessionData> sessionData, String selectTimeStart, String selectTimeEnd,String meal) {
    String startTime = widget.mealTiming[meal]!["Session${index+1}"]!["StartTime"]!;
    String endTime = widget.mealTiming[meal]!["Session${index+1}"]!["EndTime"]!;
    double baseWidth = 375;
    double fem = MediaQuery.of(context).size.width / baseWidth;
    ...
    return BlocBuilder<TimeSelectionBloc,TimeSelectState>(builder: (context,state) {
      return Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              ManageSettingFunction.showTimePickerDialog(context,"Session${index+1}","StartTime",meal);
            },
            child: Container(
              height: 40,
              width: 130,
          ...
          InkWell(
            onTap: () {
              ManageSettingFunction.showTimePickerDialog(context,"Session${index+1}","EndTime",meal);
            },
            child: Container(
              width: 130,
              height: 40,
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Icon(Icons.alarm, color: Color(0xfffbb830), size: 15,),
                    SizedBox(width: 20,),
                    Text("${widget.mealTiming[meal]!["Session${index+1}"]!["EndTime"]!}",
                      style: TextStyle(
                        fontWeight: FontWeight.w500,
                        fontFamily: 'Open Sans',
                        fontSize: 14,
                  ...
                  if(sessionData.length > 1)
                    {
                      ...
                      if(sessionData.length == 0) {
                        widget.mealTiming[meal]!["Default"]!["Enabled"] =true;
                        widget.mealTiming[meal]!["Session1"]!["Enabled"] = false;
                      }
                    }
                });
            ...
            child: InkWell(
              onTap: () {
                setState(() {
                  ...
                  widget.mealTiming[meal]!["Session${index+2}"]!["Enabled"] = true;
                });
              },
              child: Container(
                width: 25.0,
  ...
  Widget _buildSessionRowSub(int index, List<SessionData> sessionData, String selectTimeStart, String selectTimeEnd,String meal) {
  ...
  Widget _buildSessionRowMobSub(int index, List<SessionData> sessionData, String selectTimeStart, String selectTimeEnd,String meal) {
    String startTime = widget.mealTimingSub[meal]!["Session${index+1}"]!["StartTime"]!;
    String endTime = widget.mealTimingSub[meal]!["Session${index+1}"]!["EndTime"]!;
    double baseWidth = 375;
    double fem = MediaQuery.of(context).size.width / baseWidth;
  ...
  Widget mealTimeWidget(String meal,bool session,bool sessionPreorder,bool sessionSubscription)
  {
    return Row(
      children: [
        ...
        // SizedBox(width:  30,),
        // Checkbox(
        //   value: widget.mealTiming[meal]!['Default']!['Enabled'], onChanged: (val){
        //   setState(() {
        //     if (meal == "Dinner") {
        ...
        //       }
        //       widget.mealTiming["Dinner"]!["Default"]!["Enabled"] = val ?? false;
        //       widget.mealTiming["Dinner"]!["Session1"]!["Enabled"] = !widget.mealTiming["Dinner"]!["Session1"]!["Enabled"];
        ...
        //       }
        //       widget.mealTiming["Lunch"]!["Default"]!["Enabled"] = val ?? false;
        //       widget.mealTiming["Lunch"]!["Session1"]!["Enabled"] = !widget.mealTiming["Lunch"]!["Session1"]!["Enabled"];
        ...
        //       }
        //       widget.mealTiming["Breakfast"]!["Default"]!["Enabled"] = val ?? false;
        //       widget.mealTiming["Breakfast"]!["Session1"]!["Enabled"] = !widget.mealTiming["Breakfast"]!["Session1"]!["Enabled"];
        ...
        // //
        // // Checkbox(
        // //   value: sessionPreorder, onChanged: (val){
        // //
        // //   setState(() {
        // //     if(meal == "Breakfast") {
        ...
        // //
        // // Checkbox(
        // //   value: sessionSubscription, onChanged: (val){
        // //   setState(() {
        // //     if(meal == "Breakfast") {
  ...
  Widget mealTimeWidgetMob(String meal,bool session,bool sessionPreorder,bool sessionSubscription)
  {
    ...
    return Column(
      ...
      children: [
        ...
        //
        //     BlocBuilder<TimeSelectionBloc,TimeSelectState>(builder: (context,state) {
        //       return TimeControllerMob(time: widget.mealTiming[meal]!['Default']!['StartTime']!,
        //           session: 'Default', timeString: "StartTime", meal: meal);
        //     }),
        //
        //
        ...
        //     SizedBox(width:  13*fem,),
        //     // timeContainer(widget.mealTiming[meal]!['Default']!['EndTime']!,'Default',"EndTime",meal),
        //     TimeControllerMob(time: widget.mealTiming[meal]!['Default']!['EndTime']!,
        //         session: 'Default', timeString: "EndTime", meal: meal),
        //     SizedBox(width:  10*fem,),
        //     Checkbox(value: widget.mealTiming[meal]!['Default']!['Enabled'], onChanged: (val){
        //       setState(() {
        //         if (meal == "Dinner") {
        //           ManageSettingsVariables.isDinnerSessionEnabled = val ?? false;
        //           if(val == false) {

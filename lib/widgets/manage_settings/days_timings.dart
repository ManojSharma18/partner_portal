...
class DaysTimings extends StatefulWidget {
  final Map<String, Map<String, bool>> mealData;
  final Map<String,Map<String,Map<String,dynamic>>> mealTiming;

  const DaysTimings({Key? key, required this.mealData, required this.mealTiming,}) : super(key: key);

  @override
  State<DaysTimings> createState() => _DaysTimingsState();
}

class _DaysTimingsState extends State<DaysTimings> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ManageSettingsBloc,ManageSettingState>(builder: (BuildContext manageSettingContext, state) {
      if(state is ManageSettingsLoadingState) {
        return Center(child: CircularProgressIndicator(),);
      }
      if(state is ManageSettingsLoadedState){
        print("jkas jskfwe jns k dsf as as salfwe");
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        margin: EdgeInsets.only(left: 80*fem, bottom: 10),
                                                ...
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 60,),
                                                        _buildSessionRow(index, ManageSettingsVariables.sessions, ManageSettingsVariables.selectedStartTimeBF, ManageSettingsVariables.selectedEndTimeBF,'Breakfast',manageSettingContext),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                                ...
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        SizedBox(width: 60,),
                                                        _buildSessionRow(index, ManageSettingsVariables.lunchSessions, ManageSettingsVariables.selectedStartTimeLunch, ManageSettingsVariables.selectedEndTimeLunch,'Lunch',manageSettingContext),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 15,),
                                              for (int index = 0; index <
                                                  ManageSettingsVariables.dinnerSessions.length && index < 3; index++)
                                                Column(
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        _buildSessionRow(index, ManageSettingsVariables.dinnerSessions,
                                                            ...
                                                            ManageSettingsVariables.selectedEndTimeDinner,"Dinner",manageSettingContext),
                                                      ],
                                                    ),
                                                    SizedBox(height: 20),
                                                  ],
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  ManageSettingModel manageSetting = ManageSettingModel(consumptionMode: ManageSettingsVariables.consumptionMode, fpUnitAvailDaysAndMeals: ManageSettingsVariables.mealData, fpUnitSessions: ManageSettingsVariables.mealTiming, fp_unit_id: 'kaa1');

                                  manageSettingContext.read<ManageSettingsBloc>().add(UpdateTimingsEvent('kaa1',context, manageSetting));
  ...
  Widget _buildSessionRow(int index, List<SessionData> sessionData, String selectTimeStart, String selectTimeEnd,String meal,BuildContext manageSettingContext) {
      ...
      return Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() {
                ManageSettingFunction.showTimePickerDialog(manageSettingContext,"Session${index+1}","StartTime",meal);
              });
            },
            child: Container(
              height: 40,
          ...
          Visibility(
            ...
            child: InkWell(
              onTap: () {
                ...
                print(ManageSettingsVariables.mealTiming);
              },
              child: Container(
                width: 25.0,
                height: 25.0,

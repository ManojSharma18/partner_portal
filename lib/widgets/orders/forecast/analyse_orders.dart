...
import 'package:partner_admin_portal/widgets/orders/forecast/analyse_orders_mob.dart';
import 'package:partner_admin_portal/widgets/orders/forecast/analyse_orders_tab.dart';
...
class AnalyseOrders extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MenuBloc,MenuState>(builder: (BuildContext context, menuState) {

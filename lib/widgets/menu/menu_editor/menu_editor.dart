...
class _MenuEditorState extends State<MenuEditor> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<MenuBloc,MenuState>(builder: (BuildContext context, menuState) {
        ...
        if(menuState is MenuLoadedState) {
          ...
          MenuEditorVariables.subTagController.text = menuState.menuItem['subTag'].toString();
                                            ...
                                            BottomNavigationBarItem(
                                              icon: InkWell(
                                                onTap: () {
                                                  ...
                                                  menuService.updateLiveMenu(menuState.menuItem["_id"], requestBody);

...
class _LiveMenuState extends State<LiveMenu> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    print("Searched categoryA${widget.searchQuery}");
        ...
        children: [
          ...
          Expanded(
            child: ReorderableListView.builder(
              ...
              primary: true,
              shrinkWrap: true,
              itemCount: filteredFoodCategory.length == 0 ? foodCategories.length : filteredFoodCategory.length,
                              ...
                              Row(
                                children: [
                                  Container(
                                    ...
                                    height:35,
                                    child: SmallCustomTextField(
                                      textEditingController: lunchTotal,height: 30,fontSize: 11,
                                      min:0,max:9999,
                                      onChanged: (text){
                                        setState(() {
                                          if(int.parse(total.text) > 1000)
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                height:35,
                                child: SmallCustomTextField(
                                  textEditingController: dinnerTotal,height: 30,fontSize: 11,
                                  min:0,max:9999,
                                  onChanged: (text){
                                    setState(() {
                                      if(int.parse(total.text) > 1000)

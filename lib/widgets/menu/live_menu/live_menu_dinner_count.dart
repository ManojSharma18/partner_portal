...
import 'package:partner_admin_portal/widgets/menu/live_menu/live_menu_count_dinner.dart';
...
class LiveMenuDinnerCount extends StatefulWidget {
  const LiveMenuDinnerCount({super.key});

  @override
  State<LiveMenuDinnerCount> createState() => _LiveMenuBreakfastCountState();
}

class _LiveMenuBreakfastCountState extends State<LiveMenuDinnerCount> with TickerProviderStateMixin {
  ...
  Widget MenuEditorWidget({LiveMenu1LoadedState? menuState, required BuildContext liveMenuContext}) {
    ...
    double ffem = fem * 0.97;
    if(menuState != null) {
      foodCategories = LiveMenuVariables.liveMenuNewfoodCategoriesDinner;
      LiveMenuFunctions.cleanUpEmptyCategories(foodCategories);
      print("Live menu new food categories $foodCategories");


      LiveMenuVariables.dnSession1Controller.text = menuState.menuItemDinner['dinnerSession1'].toString() ?? '';
      LiveMenuVariables.dnSession2Controller.text = menuState.menuItemDinner['dinnerSession2'].toString() ?? '';
      LiveMenuVariables.dnSession3Controller.text = menuState.menuItemDinner['dinnerSession3'].toString() ?? '';
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          LiveMenuFunctions.addItemInLiveMenuDinner(liveMenuContext);
                                        },
                                      ...
                                      return ReorderableDragStartListener(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            ...
                                            liveMenuContext.read<LiveMenu1Bloc>().add(SelectLiveMenuDinnerCategoryEvent(menuState.selectedCategoriesDinner,menuState.foodCategoryDinner, category));
                                          },
                                          child: Column(
                                            key: Key('$category'),
                                            children: [
                                              Container(
                                                ...
                                                color: menuState.selectedCategoriesDinner.contains(category)
                                                    ? Color(0xFF363563)
                                                    : null,
                                                child: ListTile(
                                                  title: Text(
                                              ...
                                              Visibility(
                                                visible: menuState.selectedCategoriesDinner.contains(category),
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                  children: _buildItemsList(category, itemsList,menuState.selectedCategoriesDinner,liveMenuContext),
                                                ),
                                              ),
                                            ],
                                          ),
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        LiveMenuFunctions.updateItem(liveMenuContext, LiveMenuVariables.liveMenuNewfoodCategoriesDinner,LiveMenuVariables.liveMenuSelectItemDinner['tag'],LiveMenuVariables.liveMenuSelectItemDinner);
                                      },
                                      child: Container(
                                        width: 130,
                                        height: 40,
            ...
            child: MouseRegion(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  menuContext.read<LiveMenu1Bloc>().add(LiveMenuDinnerItemSelectEvent(item1));
                },
                child: Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(5),
                    color: LiveMenuVariables.liveMenuSelectItemDinner == item1
              ...
              InkWell(
                onTap: () {
                  Map<String,dynamic> data =  {
                    "ritem_UId": LiveMenuVariables.liveMenuSelectItemDinner['ritem_UId'],
                    "date": LiveMenuVariables.liveMenuSelectItemDinner['date']
                  };

                  liveMenuContext.read<LiveMenu1Bloc>().add(DeleteItemEvent(data,LiveMenuVariables.liveMenuNewfoodCategoriesDinner,LiveMenuVariables.liveMenuSelectItemDinner['tag'],LiveMenuVariables.liveMenuSelectItemDinner));
